...
import Utilities.ExcelProcessor;
...
public class PegaFlow extends ExcelData {
	...
	public static void main(String[] args) throws Exception {
		/*for(scenarioid=1;scenarioid<6;scenarioid++) {*/
	...
	public static void endToendFlow() throws Exception {
		...
		try {
			...
			//TestDataDO currentData = ExcelProcessor.testDataList.get(1); //pass the run number here
			...
			WebElement web = driver.findElement(By.xpath("//tr[@class='menuItem selected']"));
			...
			waitForElement(driver, "//table[@id='HarnessFooter']/tbody/tr/td[3]/table");
			driver.findElement(By.xpath("//table[@id='HarnessFooter']/tbody/tr/td[3]/table")).click();
			Thread.sleep(3000);
